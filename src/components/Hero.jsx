...
import { Play, Sparkles, Cpu, Bot, Zap, Code, ShieldCheck, Terminal, Layers, ArrowRight } from 'lucide-react';
...
export default function Hero({ onStart }) {
  const syllabusHighlights = [
    {
      icon: Cpu,
      title: "AI Ecosystems",
      desc: "Google AI Suite vs. Claude, 2M+ Context Memory Management & Tooling",
    ...
    {
      icon: Code,
      title: "Practical AI Dev",
      desc: "Prompt engineering, automated debugging & multi-module orchestration",
    ...
    },
    {
      ...
      desc: "Key security, rate limiting, regional quotas & cost optimization",
    ...
    },
    {
      ...
      desc: "Vector DBs, Embeddings, Tool Calling & Multi-Agent reasoning loops",
  ...
  return (
    <div className="relative min-h-[calc(100vh-65px)] flex flex-col justify-center items-center px-4 sm:px-6 lg:px-8 py-12 z-10 overflow-hidden">
      
      {/* Decorative background glow accents */}
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[300px] bg-sky-500/15 rounded-full blur-[120px] pointer-events-none" />
      <div className="absolute bottom-10 right-10 w-[400px] h-[250px] bg-blue-600/15 rounded-full blur-[100px] pointer-events-none" />
      ...
      <div className="max-w-5xl mx-auto w-full text-center">
        ...
        >
          ...
          <span>Interactive 6-Hour Masterclass</span>
        ...
        <motion.h1
          ...
          className="text-4xl sm:text-6xl lg:text-7xl font-extrabold text-slate-100 tracking-tight leading-[1.1] mb-6"
        >
        ...
        <motion.p
          ...
          className="text-base sm:text-xl text-slate-300 max-w-3xl mx-auto font-normal leading-relaxed mb-4"
        >
          Mastering modern AI architectures, Google Gemini ecosystem, Claude tooling, RAG, and production multi-agent systems.
        </motion.p>
        ...
        >
          <div className="flex items-center gap-2 px-3 py-1 bg-slate-900/80 border border-slate-800 rounded-lg">
            ...
            <span className="font-semibold text-slate-200">Vahid Shahparifard</span>
          </div>
          <div className="flex items-center gap-2 px-3 py-1 bg-slate-900/80 border border-slate-800 rounded-lg">
            <Terminal className="w-3.5 h-3.5 text-sky-400" />
            <span className="font-mono text-xs text-sky-300">v1.0.0 Presentation</span>
          </div>
        </motion.div>
