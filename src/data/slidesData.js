export const SLIDES_DATA = [
  ...
  },
  {
    id: 4,
    number: "۰۴",
    title: "مدیریت حافظه و پنجره سیاق (Context)",
    subtitle: "پنجره ۲ میلیون توکنی و تکنیک‌های Caching",
    section: "ساعت ۱",
    category: "حافظه و سیاق",
    instructor: "وحید شهپری فرد",
    hour: "ساعت ۱",
    description: "تحلیل بازیابی اسناد در پنجره‌های ۲M توکنی، آزمون Needle in a Haystack، تکنیک‌های Caching سیاق و استراتژی‌های خلاصه‌سازی تاریخچه."
  },
  {
    id: 5,
    number: "۰۵",
    ...
    instructor: "وحید شهپری فرد",
    hour: "ساعت ۲",
    description: "تفکیک نقش‌ها، مرزبندی سیاق با تگ‌های XML، تکنیک‌های زنجیره تفکر (Chain-of-Thought) و خروجی‌های ساختاریافته اعتبارسنجی‌شده با Pydantic."
  },
  {
    id: 6,
    number: "۰۶",
    ...
    instructor: "وحید شهپری فرد",
    hour: "ساعت ۲",
    description: "بررسی نمونه‌های واقعی پرامپت‌های تولید اسکریپت‌های سنگین، کنترل نویز و جلوگیر از توهم مدل‌ها در پاسخ‌دهی."
  },
  {
    id: 7,
    number: "۰۷",
  ...
  },
  {
    ...
    instructor: "وحید شهپری فرد",
    hour: "ساعت ۳",
    description: "استراتژی‌های شکستن کدبیس‌های چند هزار خطی به نقشه‌های سیاق ماژوله، آگاهی از درخت وابستگی‌ها و بازنویسی تدریجی با چانک‌های diff."
  },
  {
    id: 9,
    number: "۰۹",
